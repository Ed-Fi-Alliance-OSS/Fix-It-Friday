...
exports.staffConfig = {
  ...
  insertSql: 'INSERT INTO fif.staff (staffkey, personaltitleprefix, firstname, middlename, lastsurname, staffuniqueid, electronicemailaddress) VALUES ($1, $2, $3, $4, $5, $6, $7)',
  updateSql: 'UPDATE fif.staff SET personaltitleprefix=$2, firstname=$3, middlename=$4, lastsurname=$5, staffuniqueid=$6, electronicemailaddress=$7 WHERE staffkey=$1',
